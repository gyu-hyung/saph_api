...
import com.bako.api.auth.domain.MemberStatus
import com.bako.api.credit.domain.CreditReason
import com.bako.api.job.domain.JobStatus
import com.bako.api.job.domain.JobStep
...
@Configuration
@EnableR2dbcRepositories(basePackages = ["com.bako.api"])
class R2dbcConfig(
    ...
    override fun connectionFactory(): ConnectionFactory {
        val url = r2dbcProperties.url
            ?: "r2dbc:postgresql://postgres:5432/bako"
        ...
        val database = if (hostPortDb.size > 1) hostPortDb[1].split("?")[0] else "bako"

        val username = r2dbcProperties.username ?: "bako"
        val password = r2dbcProperties.password ?: "bako"
